...
x_ticks = np.arange(
    minlongitude,
    maxlongitude + maxlongitude / 10000,
    float("{0:.3f}".format(maxlongitude - minlongitude)) / 5,
)
y_ticks = np.arange(
    minlatitude,
    maxlatitude + maxlatitude / 10000,
...
map.drawparallels(
    y_ticks, color="black", linewidth=0.5, labels=[True, False, False, False]
)
map.drawmeridians(
    x_ticks, color="0.25", linewidth=0.5, labels=[False, False, False, True]
)
