...
domain = RectangularDomain(
    minlongitude=statLon_min,
    maxlongitude=statLon_max,
    minlatitude=statLat_min,
    maxlatitude=statLat_max,
)
...
mdl.download(
    domain, restrictions, mseed_storage=folder_output, stationxml_storage=folder_output
)
